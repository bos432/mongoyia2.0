...
CREATE TABLE `fb_mall_order` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `store_id` bigint(20) unsigned NOT NULL DEFAULT '1' COMMENT '商家',
  `parent_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '父订单',
  `user_id` bigint(20) unsigned NOT NULL COMMENT '用户',
  ...
  `stock_deducted_at` int(11) NOT NULL DEFAULT '0' COMMENT '库存扣减时间',
  `stock_refunded_at` int(11) NOT NULL DEFAULT '0' COMMENT '库存返还时间',
