<?php
return [
    // MONGOYIA_PHASE13_ASSET_CACHE_BUST_V2: force refreshed mall H5 assets for cart/browser acceptance.
    ...
    'defaultStoreId' => (int)env('DEFAULT_STORE_ID', 2), //默认店铺ID，当不存在时用该id
    'defaultUserId' => (int)env('DEFAULT_USER_ID', 2), //默认用户ID
    ...
    'siteName' => env('SITE_NAME', 'Mongoyia'),
    ...
    'defaultRoute' => env('DEFAULT_ROUTE', 'site'),
    ...
    // Snowflake唯一ID
    'snowFlakeUniqueId' => true, // 修改此处不会影响ID顺序，如ID按照15261***开头，修改还是15261***开头，并且按照先后顺序
    ...
    'imWebsocketUrl' => env('IM_WEBSOCKET_URL', 'ws://127.0.0.1:8767'),
    'imAuthSecret' => env('IM_AUTH_SECRET', ''),
    'imAuthTokenTtl' => (int)env('IM_AUTH_TOKEN_TTL', 3600),
    ...
    'frontendTranslateEnabled' => env_bool('FRONTEND_TRANSLATE_ENABLED', false),
    ...
    'uploaderConfig' => [
        ...
        // 图片
        'image' => [
            'httpPrefix' => env('UPLOAD_HTTP_PREFIX', '/attachment/'), // http前缀
            'originalName' => false, // 是否保留原名
            'fullPath' => true, // 是否开启返回完整的文件路径
            'takeOverUrl' => env('UPLOAD_TAKEOVER_URL', ''), // 配置后，接管所有的上传地址
    ...
    // 平台url店名前缀，例如 /store-demo
    'storePlatformUrlPrefix' => 'store-',
    'storePlatformDomain' => env('STORE_PLATFORM_DOMAIN', 'www.mongoyia.com'),
    'storePlatformRoute' => env('STORE_PLATFORM_ROUTE', 'mall'),
    'mallPlatformMode' => env_bool('MALL_PLATFORM_MODE', true),
    'mallPlatformStoreIds' => env('MALL_PLATFORM_STORE_IDS', ''),
    'mallPlatformOperatorStoreIds' => env('MALL_PLATFORM_OPERATOR_STORE_IDS', ''),
    'storePlatformValidTime' => 365 * 86400,
    'storePlatformRoleId' => 50,
    'mallAutoReceiveDays' => (int)env('MALL_AUTO_RECEIVE_DAYS', 7),
