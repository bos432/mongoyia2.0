...
foreach (Lang::getLanguageCode() as $id => $code) {
    if (($store->lang_frontend & $id) == $id) {
        $strLang .= '<li class="lang-store">' . Html::a('<i class="flag-icon flag-icon-' . Lang::getLanguageFlag($id) .'"></i> ', \frontend\helpers\Url::attachLang($code)) . '</li>';
    }
}
...
<!--                        <a href="#"><img src="data:image/webp;base64,"></a>-->
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 mb-3">
                <div class="footer-widget">
                    ...
                    <ul>
                        <li><a href="<?= Url::to(['default/about']) ?>"><?= Yii::t('app', 'About') ?></a></li>
                        <li><a href="<?= Url::to(['default/help']) ?>"><?= Yii::t('app', 'Help') ?></a></li>
                        <li><a href="<?= Url::to(['default/feedback']) ?>"><?= Yii::t('app', 'Contact') ?></a></li>
                        <li><a href="<?= Url::to(['default/faq']) ?>"><?= Yii::t('app', 'FAQ') ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 mb-3">
                <div class="footer-widget">
                    ...
                    <ul>
                        <li><a href="<?= Url::to(['user/setting']) ?>"><?= Yii::t('app', 'Profile') ?></a></li>
                        <li><a href="<?= Url::to(['user/order']) ?>"><?= Yii::t('app', 'Orders') ?></a></li>
                        <li><a href="<?= Url::to(['cart/index']) ?>"><?= Yii::t('app', 'Cart') ?></a></li>
                        <li><a href="<?= Url::to(['user/favorite']) ?>"><?= Yii::t('app', 'Favorite') ?></a></li>
                        <li><a href="<?= Url::to(['user/history']) ?>"><?= Yii::t('app', 'History') ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-8 col-sm-8 mb-3">
                <div class="footer-newsletter">
                    ...
                    <form action="<?= Url::to(['default/subscribe']) ?>">
                ...
                <div class="funmall-menu-widget" id="bottom-lan">
...
<!--                        <div>--><?php //= Lang::getLanguageCodeLabels(Yii::$app->language) ?><!--</div>-->
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <div class="footer-copyright-text">
                    <p>Copyright © <script>document.write(new Date().getFullYear());</script> <?= Yii::t('app', 'All rights reserved') ?>
                </div>
