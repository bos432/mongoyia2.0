...
//                    'filterModel' => $searchModel,
                    ...
                    'columns' => [
                        ...
                        'id',
                        ['attribute' => 'store_id', 'visible' => $isPlatformOperator, 'value' => function ($model) { return $model['store_id']; }, 'filter' => true],
//                        'price',
...
<?php if ($isPlatformOperator): ?>
    <?= $this->render('@backend/modules/mall/views/order-product/_filter', ['model' => $searchModel, 'dataProvider' => $dataProvider]) ?>
<?php endif; ?>
