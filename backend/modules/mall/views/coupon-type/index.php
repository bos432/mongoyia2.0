            ...
            <div class="card-body">
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        'min_amount',
                        'max_times',
                        ['attribute'=>'used_times','value'=>function($model){return \common\models\mall\UserCoupon::find()->where(['cid'=>$model->id])->count();}],
                        ['attribute'=>'sy_times','value'=>function($model){return $model->max_times - \common\models\mall\UserCoupon::find()->where(['cid'=>$model->id])->count();}],
                        'started_at:datetime',
                        'ended_at:datetime',
                        'sn',
                        ...
                        [
                            ...
                            'buttons' => [
                                ...
                                'fh' => function ($url, $model, $key) {
                                    return Html::editModal(['fh-ajax', 'id' => $model->id],'下发');
                                },
