    ...
    private function providerContracts(): array
    {
        return [
            [
                ...
                'env' => 'Backend encrypted config; no secret-bearing QPAY_* runtime env fallback',
            ...
            [
                'provider' => 'LianLian',
                'state' => 'Implemented / backend-config controlled',
                'env' => 'Backend encrypted config; no secret-bearing LIANLIAN_* runtime env fallback',
            ...
            [
                'provider' => 'PayPal',
                'state' => 'Implemented / backend-config controlled',
                'env' => 'Backend encrypted config; legacy PAYPAL_ENABLED env flag is ignored',
