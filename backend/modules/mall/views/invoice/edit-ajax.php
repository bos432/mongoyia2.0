...
use common\models\mall\Invoice as ActiveModel;


/* @var $this yii\web\View */
/* @var $model common\models\mall\Invoice */
...
<!--        --><?php //= $form->field($model, 'user_id')->dropDownList(ActiveModel::getUserIdLabels()) ?>
