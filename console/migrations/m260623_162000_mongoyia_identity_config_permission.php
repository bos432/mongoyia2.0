...
class m260623_162000_mongoyia_identity_config_permission extends Migration
{
    private $permissions = [
        7063 => [
            'parent_id' => 7060,
            'name' => '第三方登录配置',
            'path' => '/mall/operational-config/identity-config*',
        ...
        7064 => [
            'parent_id' => 7063,
            'name' => '保存第三方登录配置',
            'path' => '/mall/operational-config/save-identity-config*',
            'icon' => '',
            'level' => 5,
            'sort' => 50,
        ],
        7065 => [
            'parent_id' => 7063,
            'name' => '检测第三方登录配置',
            'path' => '/mall/operational-config/check-identity-config*',
            'icon' => '',
            'level' => 5,
            'sort' => 51,
        ],
