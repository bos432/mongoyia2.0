...
<div class="row page-section payment-result payment-succeeded" data-mongoyia-mobile-ui="payment-succeeded">
        ...
        <div class="card message-send-view">
            ...
            <div class="card-body">
                ...
                <div class="form-group text-center">
                    <p><?= Yii::t('mall', 'Thank you! We will dispatch order ') ?><?= Html::encode($model->sn) ?> <?= Yii::t('mall', ' as soon as possible') ?></p>
                </div>
