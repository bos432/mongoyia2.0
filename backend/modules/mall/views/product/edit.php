            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="tab-content-1">
                        ...
                        <?= $sa?$form->field($model, 'status')->radioList(ActiveModel::getStatusLabels()):'' ?>
                    </div>
                    ...
                    <div class="tab-pane fade show" id="tab-content-2">
                        ...
                        <div class="row field-product-is-attribute-no">
                            ...
                            <div class="col-sm-3 pr-3" style="display: none"><?= $form->field($model, 'cost_price')->textInput(['maxlength' => true]) ?> </div>
...
<script id="table-header" type="text/html">
    <tr>
        ...
        <th class="th-price" style="display: none"><?= Yii::t('app', 'Cost Price') ?></th>
...
<script id="table-body" type="text/html">
    ...
    <tr id="{{value.sku}}">
        ...
        <td style="display: none"><input type="text" name="skus[{{value.sku}}][cost_price]" maxlength="10" class="js-skus-3 form-control" value="0"></td>
