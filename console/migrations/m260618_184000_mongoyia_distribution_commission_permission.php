...
class m260618_184000_mongoyia_distribution_commission_permission extends Migration
{
    private $permissions = [
        5868 => [
            'parent_id' => 22,
            'name' => '分销佣金审核',
            'path' => '/mall/distribution-commission/index',
        ...
        5869 => [
            'parent_id' => 5868,
            'name' => '分销佣金审核操作',
            'path' => '/mall/distribution-commission/*',
            'icon' => '',
            'level' => 4,
            'sort' => 50,
        ],
