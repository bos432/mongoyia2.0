...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Product Visit Today</span>
                <span class="info-box-number"><?= $product_visit_today ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Product Visit</span>
                <span class="info-box-number"><?= $product_visit ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
...
<!--                <h5 class="card-title">--><?php //= Yii::t('app', 'User Register Count') ?><!--</h5>-->
...
<!--            <!-- /.card-header -->
<!--            <div class="card-body">-->
<!--                --><?php //= \common\widgets\echarts\Echarts::widget([
