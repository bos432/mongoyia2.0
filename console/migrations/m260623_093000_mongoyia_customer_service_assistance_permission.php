...
class m260623_093000_mongoyia_customer_service_assistance_permission extends Migration
{
    private $permissions = [
        5896 => [
            'parent_id' => 5853,
            'name' => '客服订单商品查询',
            'path' => '/mall/kf/assistance-search',
            'icon' => '',
            'level' => 4,
            'sort' => 71,
        ],
        5897 => [
            'parent_id' => 5853,
            'name' => '客服订单商品详情',
            'path' => '/mall/kf/assistance-detail',
            'icon' => '',
            'level' => 4,
            'sort' => 72,
        ],
        5898 => [
            'parent_id' => 5853,
            'name' => '客服协助处理单',
            'path' => '/mall/kf/assistance-request',
            'icon' => '',
            'level' => 4,
            'sort' => 73,
        ],
        ...
        foreach ($this->permissions as $id => $item) {
            ...
            if (!$exists) {
                $this->insert('{{%base_permission}}', [
                    ...
                    'name' => $item['name'],
                    'app_id' => 'backend',
                    'brief' => 'Phase 9 customer-service order/product assistance APIs',
                    'path' => $item['path'],
                    'icon' => $item['icon'],
                    'tree' => '',
                    'level' => $item['level'],
