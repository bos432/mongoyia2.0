...
<section class="shop spad" data-mongoyia-mobile-ui="category">
    <div class="container">
        <div class="row">
                ...
                <div class="shop-sidebar">
                    ...
                    <div class="sidebar-filter">
                        ...
                        <div class="filter-range-wrap">
                            <?php $min = (int)str_replace(',','',mb_substr($this->context->getNumberByCurrency(isset($priceMinMax['min']) ? floor($priceMinMax['min']) : 0),1));
                                $max = (int)str_replace(',','',mb_substr($this->context->getNumberByCurrency(isset($priceMinMax['max']) ? ceil($priceMinMax['max']) : 100000000),1));
                                if($max == $min){
                                    $min = 0;
                                    $max = 99999999;
                                }?>
                            <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content" data-min="<?= $min; ?>" data-max="<?= $max;  ?>"></div>
                        ...
                        <a href="javascript:;" data-url="<?= Yii::$app->request->getUrl() ?>" style="bottom: unset" class="btn-filter-price"><?= Yii::t('app', 'Filter') ?></a>
                    </div>
