...
$canManageCategories = $this->context->isMallPlatformOperator();
?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <?= $canManageCategories ? Html::create() : '' ?>
<!--                    --><?php //= Html::export() ?>
<!--                    --><?php //= Html::import() ?>
                </div>
            </div>
...
//                        ],
                        ...
                        [
                            'attribute' => 'name',
                            'format' => 'raw',
                            'value' => function ($model, $key, $index, $column) use ($canManageCategories) {
                        ...
                        ['attribute' => 'status', 'format' => 'raw', 'value' => function ($model) { return ActiveModel::isStatusActiveInactive($model->status) ? Html::status($model->status) : ActiveModel::getStatusLabels($model->status, true); }],
                        ...
                        [
                            ...
                            'template' => $canManageCategories ? '{edit-sub} {edit} {delete}' : '{view}',
                            'buttons' => [
