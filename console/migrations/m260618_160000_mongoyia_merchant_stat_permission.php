...
class m260618_160000_mongoyia_merchant_stat_permission extends Migration
{
    private $permissions = [
        5853 => [
            'parent_id' => 22,
            'name' => '商家统计',
            'path' => '/mall/merchant-stat/index',
    ...
    private function grantToActiveRoles(int $now)
    {
        if ($this->db->schema->getTableSchema('{{%base_role_permission}}', true) === null) {
            return;
        }
