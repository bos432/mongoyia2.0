...
class m260621_162000_mongoyia_customer_service_complaint_evidence_permission extends Migration
{
    private $permissions = [
        5890 => [
            'parent_id' => 5853,
            'name' => '客服投诉证据上传',
            'path' => '/mall/kf/complaint-evidence-upload',
            'icon' => '',
            'level' => 4,
            'sort' => 65,
        ],
        5891 => [
            'parent_id' => 5853,
            'name' => '客服投诉证据查看',
            'path' => '/mall/kf/complaint-evidence-view',
            'icon' => '',
            'level' => 4,
            'sort' => 66,
        ],
        5892 => [
            'parent_id' => 5853,
            'name' => '客服投诉证据删除',
            'path' => '/mall/kf/complaint-evidence-delete',
            'icon' => '',
            'level' => 4,
            'sort' => 67,
        ],
        ...
        foreach ($this->permissions as $id => $item) {
            ...
            if (!$exists) {
                $this->insert('{{%base_permission}}', [
                    ...
                    'name' => $item['name'],
                    'app_id' => 'backend',
                    'brief' => 'Phase 8 customer-service complaint evidence image workflow',
                    'path' => $item['path'],
                    'icon' => $item['icon'],
                    'tree' => '',
                    'level' => $item['level'],
