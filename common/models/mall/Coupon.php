...
class Coupon extends CouponBase
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['store_id', 'user_id', 'coupon_type_id', 'order_id', 'used_at', 'type', 'sort', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['user_id', 'money', 'started_at', 'ended_at'], 'required'],
            [['min_amount', 'min_product_amount'], 'number'],
