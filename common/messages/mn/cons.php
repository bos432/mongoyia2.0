...
return [
    ...
    'TYPE_DROP_DOWN_LIST' => "Dropdown List",
    'TYPE_MULTIPLE_INPUT' => "Multiple Input",
    'TYPE_RADIO_LIST' => "Radio List",
    'TYPE_CHECKBOX_LIST' => "Checkbox List",
    'TYPE_BAIDU_UEDITOR' => "Baidu Ueditor",
    'TYPE_IMAGE' => "Image",
    'TYPE_IMAGES' => "Images",
    'TYPE_FILE' => "File",
    'TYPE_FILES' => "Files",
    'TYPE_CROPPER' => "Cropper",
