...
<ul class="nav nav-tabs card-header-tabs user-card-header-tabs">
    ...
    <li class="nav-item"><a href="<?= Url::to(['/mall/user/history']) ?>" class="nav-link <?= $type == 'history' ? 'active' : '' ?>"><i class="fa fa-history"></i> <span><?= Yii::t('app', 'History') ?></span></a></li>
    <li class="nav-item"><a href="<?= Url::to(['/mall/user/distribution']) ?>" class="nav-link <?= $type == 'distribution' ? 'active' : '' ?>"><i class="fa fa-share-alt"></i> <span><?= Yii::t('app', 'Distribution') ?></span></a></li>
